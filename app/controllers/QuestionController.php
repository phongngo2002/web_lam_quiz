...
class QuestionController{
    public function index($id){
        ...
        // $VIEW_PAGE = "./app/views/question/index.php";
    ...
    public function saveAdd($id){
        ...
        move_uploaded_file($_FILES["form-img"]["tmp_name"],$_SERVER["DOCUMENT_ROOT"].'/asm1/img/'.$img);
        try{
            $conn = new PDO('mysql:host=127.0.0.1;dbname=ass;charset=utf8', 'root', '');
            try{
                $data_question = [
                ...
                try{
                    $uploadImg = fn($tmp,$src) =>  move_uploaded_file($tmp,$_SERVER["DOCUMENT_ROOT"].'/asm1/img/'.$src);
                    $id_ques =  $model->id;
                    $img = array();
                    for ($i=1; $i < 5; $i++) { 
    ...
    public function updateForm($id){
        ...
        // $VIEW_PAGE = "./app/views/question/form-update.php";
        // include "./app/views/layout.php";
    }
